...
(
    ...
    `is_featured`      boolean        not null default false comment '是否精选商品',
    `is_hot`           boolean        not null default false comment '是否店铺热门商品',
    ...
    `good_analyse`     decimal(5, 2)           default (100.0) comment '好评率',
